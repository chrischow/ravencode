...
#sed -E 's/(codicon\..*)\.ttf/rsaf\/RDO\/devtools\/main\/\1.txt/' "./build/index-fixed.html" > "./build/index.html"
sed -E 's/(codicon\..*)\.ttf/\1.txt/' "./build/index-fixed.html" > "./build/index.html"
